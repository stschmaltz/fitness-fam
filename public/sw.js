if (!self.define) {
  ...
  self.define = (i, n) => {
    ...
    s[c] = Promise.all(i.map((e) => d[e] || o(e))).then((e) => (n(...e), r));
  };
}
define(['./workbox-588899ac'], function (e) {
  'use strict';
  importScripts('fallback-kPcKU8KkMQWjNCZWbh42l.js'),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/kPcKU8KkMQWjNCZWbh42l/_buildManifest.js',
          revision: '51170628daa089ac8b99576a0ec59e9f',
        },
        {
          url: '/_next/static/kPcKU8KkMQWjNCZWbh42l/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        { url: '/_offline', revision: 'kPcKU8KkMQWjNCZWbh42l' },
        ...
        { url: '/manifest.json', revision: '7de3eb781d092286fd0167963e3b475c' },
        {
          url: '/qrcode_www.fitnessfam.app.png',
          revision: 'c302f0f1c52ecc2c3e25da6da8ae2579',
        },
      ],
